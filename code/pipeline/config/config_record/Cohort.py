CohortName_to_OneCohortArgs= {
    ...
    'WellDoc2023CVSTDC': {
        ...
        'SourcePath': 'Source',
        'FolderPath': '$DATA_RAW$/WellDoc2023CVSTDC/', 
        'Source2CohortName': 'WellDocV240629',
    }, 
    'WellDoc2023CVSDeRx': {
        'CohortLabel': 3, 
    ...
    'WellDoc2025ALS': {
        ...
        # path: $DATA_RAW$CohortName.
        'FolderPath': f'$DATA_RAW$/WellDoc2025ALS/', 
        'SourcePath': '',
        'Source2CohortName': 'WellDocV240629', # you can make up this name. 
    },
    ...
    'WellDoc2025CVS': {
        ...
        # path: $DATA_RAW$CohortName.
        'FolderPath': f'$DATA_RAW$/WellDoc2025CVS/', 
        'SourcePath': '',
        'Source2CohortName': 'WellDocV240629', # you can make up this name. 
    },
    ...
    'WellDoc2025LLY': {
        ...
        # path: $DATA_RAW$CohortName.
        'FolderPath': f'$DATA_RAW$/WellDoc2025LLY/', 
        'SourcePath': '',
        'Source2CohortName': 'WellDocV240629', # you can make up this name. 
    },
    ...
    'aireadi-noimage-v2': {
        ...
        'SourcePath': 'Source',
        'FolderPath': '$DATA_RAW$/aireadi-noimage-v2/', 
        'Source2CohortName': 'AIREADIv2V250312',
    },
    ...
    'CGMacros': {
        ...
        'CohortName': 'CGMacros', 
        'SourcePath': 'Source',
        'FolderPath': '$DATA_RAW$/CGMacros/', 
        'Source2CohortName': 'CGMacrosV250602',
    },
    ...
    'dubosson': {
        ...
        'CohortName': 'dubosson', 
        'SourcePath': 'Source',
        'FolderPath': '$DATA_RAW$/dubosson/', 
        'Source2CohortName': 'dubossonV250619',
    },
