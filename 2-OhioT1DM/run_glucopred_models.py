...
from neuralforecast.models import (
    Informer, VanillaTransformer, Autoformer, FEDformer,
    LSTM, GRU, RNN
)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--model_type', type=str, default='patchtst',
                        choices=[
                            # Neural models
                            'informer', 'transformer', 'autoformer', 'fedformer', 
                            'lstm', 'gru', 'rnn', 
                        ],
...
python 2-OhioT1DM/run_glucopred_models.py --model_type fedformer --input_length 289 --output_length 24 --n_trials 10
"""